...
//-=Fotios=-
//void find_chroma_spike_cols(short);
//void eliminate_false_spikes();
//void decodeStegMessage();
...
//extern Compress_info_struct my_cinfo_struct;
//extern compress_info_ptr    my_cinfo;
extern my_compress_info_struct* my_cinfo;
